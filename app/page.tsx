...
function WhyChooseUs() {
  ...
  return (
    <section
      className="relative lg:-mt-2 h-auto lg:h-screen justify-items-center max-w-7xl mx-auto px-2 sm:px-4 mb-20 sm:mb-24"
      aria-label="Why you should choose us?"
    >
      <div className="flex flex-col items-center justify-center text-center gap-2 mb-8 sm:mb-12 px-2 sm:px-0">
        <h1 className="text-lg xs:text-xl sm:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-gray-100 to-indigo-300">
          Why you should choose us?
        </h1>
        <p className="text-xs xs:text-sm sm:text-base font-medium text-gray-400 max-w-[90vw] sm:max-w-xs md:max-w-xl">
  ...
  <RadialGlow className="  border border-[#23233a] bg-[#181825]/60 group md:w-2/6 w-full rounded-xl p-4 sm:p-8 flex flex-col items-start justify-center text-center min-h-[260px] sm:min-h-[340px]">
    ...
    <p className="text-xs sm:text-base font-medium text-gray-500 max-w-[80vw] mb-3 sm:mb-8">
      Your privacy matters to us. That`s why we do our best to protect your privacy.
    </p>
    <div className="w-full flex-grow flex items-center justify-center min-h-[80px] sm:min-h-[120px] flex-shrink-0">
      <Image
        src="https://illustrations.popsy.co/amber/man-riding-a-rocket.svg"
        alt="Privacy illustration"
        width={120}
        height={120}
        className="object-contain max-w-full max-h-[120px] sm:max-h-[160px] invert mt-2 sm:mt-4"
      />
    </div>
  </RadialGlow>
        ...
        <div className="md:flex-1 flex flex-col gap-4 sm:gap-8 max-w-2xl w-full">
          <RadialGlow className="border border-[#23233a] bg-[#181825]/60 group  rounded-xl p-3 sm:p-6 flex flex-col sm:flex-row justify-between items-center w-full min-h-[120px] sm:min-h-[180px]">
            ...
            <div className="flex-shrink-0 ml-0 sm:ml-20 mt-4 sm:mt-0 min-h-[80px] sm:min-h-[120px] flex items-center justify-center">
              <Image
                src="https://illustrations.popsy.co/amber/woman-hugging-earth.svg"
                alt="Globalization illustration"
                width={80}
                height={80}
                className="object-contain w-20 h-20 sm:w-32 sm:h-32 md:w-60 md:h-60 invert"
              />
            </div>
          </RadialGlow>
  ...
  return (
    <>
      ...
      <main className="min-h-screen pb-8 sm:pb-12 space-y-24 sm:space-y-56 my-12 sm:my-24">
        ...
        {/* Services Section */}
        <section
          className="relative justify-items-center px-2 sm:px-0 mt-20 sm:mt-0"
